...
interface ImposterWinProps {
  imposterName: string;
  onPlayAgain: () => void;
}

const ImposterWin: React.FC<ImposterWinProps> = ({ imposterName, onPlayAgain }) => {
  ...
  console.log('ImposterWin - imposterName:', imposterName);
    ...
    <div className="relative h-screen w-screen bg-retro-sky flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative flex flex-col items-center justify-center gap-10 px-10 z-10">
        ...
        <div className="relative flex items-center justify-center min-w-[300px]">
          ...
          {/* The "IMPOSTER WON!" Text - Masked Reveal */}
          <h1 
            className={`
          ...
          <div 
            className={`
              ...
              ${status !== RevealStatus.IDLE 
                ? 'translate-x-[450px] rotate-[720deg]' 
                : '-translate-x-[450px] rotate-0'}
            `}
          >
            <img 
              src={imageUrl} 
        ...
        {/* The Subtitle - Appears after "IMPOSTER won!" reveal */}
